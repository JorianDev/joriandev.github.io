...
const zetelData = {
    ...
    peilingMDH_Apr18: {
        ...
        data: [
            { naam: "PVV", zetels: 19, kleur: "#1E90FF"},
            { naam: "GroenLinks/PvdA", zetels: 23, kleur: "#ff0000"},
            { naam: "VVD", zetels: 17, kleur: "#ff6400"},
            { naam: "CDA", zetels: 16, kleur: "#2cc84d"},
            { naam: "D66", zetels: 20, kleur: "#00ae41"},
            { naam: "JA21", zetels: 17, kleur: "#242b57"},
            { naam: "SP", zetels: 3, kleur: "#ec1b23"},
            { naam: "FVD", zetels: 16, kleur: "#84171a"},
    ...
    peilingMDH_Jan18: {
        ...
        data: [
            { naam: "PVV", zetels: 17, kleur: "#1E90FF"},
            { naam: "GroenLinks/PvdA", zetels: 20, kleur: "#ff0000"},
            { naam: "VVD", zetels: 21, kleur: "#ff6400"},
            { naam: "CDA", zetels: 18, kleur: "#2cc84d"},
            { naam: "D66", zetels: 28, kleur: "#00ae41"},
            { naam: "JA21", zetels: 11, kleur: "#242b57"},
            { naam: "SP", zetels: 3, kleur: "#ec1b23"},
            { naam: "FVD", zetels: 14, kleur: "#84171a"},
            { naam: "PvdDieren", zetels: 3, kleur: "#00621e"},
            { naam: "SGP", zetels: 3, kleur: "#e95d0f"},
            { naam: "DENK", zetels: 3, kleur: "#00b7b3"},
            { naam: "Volt", zetels: 1, kleur: "#502378"},
    ...
    peilingEenV_Nov25: {
        ...
        data: [
            { naam: "D66", zetels: 31, kleur: "#00ae41"},
            { naam: "PVV", zetels: 22, kleur: "#1E90FF"},
            { naam: "VVD", zetels: 20, kleur: "#ff6400"},
            { naam: "GroenLinks/PvdA", zetels: 16, kleur: "#ff0000"},
            { naam: "CDA", zetels: 20, kleur: "#2cc84d"},
            { naam: "JA21", zetels: 9, kleur: "#242b57"},
            { naam: "SP", zetels: 3, kleur: "#ec1b23"},
            { naam: "FVD", zetels: 10, kleur: "#84171a"},
            { naam: "PvdDieren", zetels: 3, kleur: "#00621e"},
    ...
    peilingMDH_Nov22: {
        ...
        data: [
            ...
            { naam: "GroenLinks/PvdA", zetels: 18, kleur: "#ff0000"},
            { naam: "CDA", zetels: 17, kleur: "#2cc84d"},
            { naam: "JA21", zetels: 9, kleur: "#242b57"},
            { naam: "SP", zetels: 3, kleur: "#ec1b23"},
            { naam: "FVD", zetels: 10, kleur: "#84171a"},
            { naam: "PvdDieren", zetels: 3, kleur: "#00621e"},
